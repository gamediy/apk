...
import 'package:bet/pages/deposit_usdt/record/record_logic.dart';
import 'package:bet/theme/theme_style.dart';
import 'package:easy_refresh/easy_refresh.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class DepositUsdtRecordPage extends StatelessWidget {
  DepositUsdtRecordPage({Key? key}) : super(key: key);
  final logic = Get.put(DepositUsdtRecordLogic());
