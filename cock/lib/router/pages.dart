...
class Pages {
  ...
  static final List<GetPage> routes = [
   ...
   //GetPage(name: Name.My, page: () => MyPage(), transition: Transition.noTransition,),
    ...
    GetPage(name: Name.DepositConfirm, page: () => Confirm(), transition: Transition.noTransition,),
    GetPage(name: Name.BetCock, page: () => CockPage(), transition: Transition.rightToLeft,),
